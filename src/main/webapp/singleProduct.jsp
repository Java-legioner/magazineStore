...
<div class="container single-product cont">
    <div class="col">
        <div class="card card-style">
            <div class="card-body">
                ...
                <button type="button" class="btn btn-primary btn-prod" data-toggle="modal"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" product-id="${product.id}"  class="btn btn-primary buy-product btn-prod">Buy</button>
            </div>
        </div>
    </div>
</div>
